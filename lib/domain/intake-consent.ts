...
const INTAKE_CONSENT_NL =
  "Ik begrijp hoe Shepherds Oud Care de verstrekte gegevens gebruikt en deelt. Ik bevestig dat ik toestemming heb om informatie over de zorgvrager te delen.";

const INTAKE_CONSENT_EN =
  "I understand how Shepherds Oud Care uses and shares the information provided. I confirm I have permission to share information about the person needing care.";
